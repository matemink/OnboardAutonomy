...
bool valid_observation(const domain::TargetObservation& observation,
...
const domain::TargetObservation* best_observation(
...
TargetTrackSnapshot TargetTracker::snapshot(const domain::TimePoint now) const {
