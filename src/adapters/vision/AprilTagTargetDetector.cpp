...
class Correspondences {
  public:
    ...
    void
    add(const float tag_x, const float tag_y, const domain::ImagePoint& image) {
...
class AprilTagTargetDetector final : public application::ports::TargetDetector {
  public:
    explicit AprilTagTargetDetector(const AprilTagDetectorConfig& config)
        ...
        if (pose_config_.has_value()) {
            domain::validate_camera_calibration(pose_config_->calibration);
