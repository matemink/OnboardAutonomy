...
void require_supported_schema(const Json& document) {
    ...
    const std::array<std::string,
        mission::CameraCalibration::kDistortionCoefficientCount>
...
mission::CameraCalibration parse_document(const Json& document) {
...
mission::CameraCalibration CameraCalibrationLoader::from_file(
...
mission::CameraCalibration CameraCalibrationLoader::from_stream(
    std::istream& input) {
    try {
