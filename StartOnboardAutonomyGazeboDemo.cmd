...
set "FIDUCIAL_LANDING_VALUE=1"
if "%ONBOARD_AUTONOMY_AERIAL_OBSERVATION%"=="1" (
    set "AUTONOMY_ENV=ONBOARD_AUTONOMY_AERIAL_OBSERVATION=1"
    set "FIDUCIAL_LANDING_VALUE=0"
)
