...
struct TargetTrackSnapshot {
    ...
    std::optional<mission::CameraFramePosition> position;
};
...
class TargetTracker {
  public:
    ...
    [[nodiscard]] TargetTrackSnapshot snapshot(mission::TimePoint now) const;
  ...
  private:
    ...
    std::optional<mission::CameraFramePosition> position_;
};
